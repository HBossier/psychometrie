...
\begin{itemize}
	...
	$\sigma$  			& $ 167.64 $ 			& $ 3.211 $  	& . 	  & $.$				 & $84.7 $	& $ . $& $ 1.2 + 1.3 +  615.8 +1.3$ \\
	$n_.$ 				& . 					& $3$			& .			  & $.$		  		 & $2*3$	& $ . $&  $2 *3$ \\ \hline
	$\sigma / n_.$      & .						& $1.0703 $		& .  & $.$			  	 & $14.11667$	& $ . $&  103.2667 \\ \hline
	\end{tabular} \\
	De grafische weergave van dit opzet is het volgende:\\
...
\begin{itemize}
	...
	\begin{align*}
		\sigma^2_{abs.~meting} 	&=  \dfrac{\hat{\sigma}^2_{k}}{n_k} + \dfrac{\hat{\sigma}^2_{p, kp, dp, dpk, e}}{n_p*n_k} \\
								&=  \dfrac{{3.122}}{3} + \dfrac{{1.2 + 1.3 +  615.8 +1.3}}{2*3}\\
								&=  1.0703 + 103.2667 &= 104.337
	\end{align*}
	Bijgevolg kan $G$ opgesteld worden door $\sigma^2_{rel.~meting}$ en $\hat{\sigma}^2_{d}$ in te vullen in vergelijking \ref{eq.phi}:
	\begin{align*}
		\phi 	&=\dfrac{167.64}{167.64+  104.337}\\
				&=\dfrac{167.64}{271.977}=0.3517
	\end{align*}
	\end{itemize}
