...
\begin{itemize}
	...
	\item De delinquenten in kwestie  zitten verspreid over 2 instellingen (25/25) waarbij er per instelling slechts twee psychologen beschikbaar zijn. 
	In de ene instelling ($p_1$ en $p_2$) werden kaarten $1-3$ door $p_1$ gescoord en kaarten $4-6$ door $p_2$; in de andere instelling ($p_3$ en $p_4$)werden kaarten $4-6$ gescoord door $p_4$ en de kaarten $1-3$ door $p_3$. 
\end{itemize}
...
\begin{itemize}
	...
	$n_.$				& .						& 6						& 3*6				 		& 6			  		  & $. $	& $ . $&  3*6 \\ \hline
	$\sigma / n$ 		& .						& 0.5352				& 34.2833				 	& 0.2167			  	 & $. $	& $ . $& 4.7722 \\ \hline
	\end{tabular} \\
	...
	$n_.$ 				& . 					& $.$			& 2			  & $.$		  		 & $2*6$	& $ . $&  $2 *6$ \\ \hline
	$\sigma / n_.$      & .						& $. $			& $307.9$  & $.$			  	 & $7.0583$	& $ . $&  0.5843 \\ \hline
	\end{tabular} \\
	De grafische weergave van dit opzet is het volgende:\\
...
\begin{itemize}
	...
	\begin{align*}
		\sigma^2_{abs.~meting} 	&=  \dfrac{\hat{\sigma}^2_{p}}{n_p} + \dfrac{\hat{\sigma}^2_{k, kp, dk, dpk, e}}{n_p*n_k} \\
								&=  \dfrac{{615.8}}{2} + \dfrac{{1.2 + 1.3 +  3.211 +1.3}}{2*6}\\
								&=  307.9 + 0.5843 &= 308.4843
	\end{align*}
	Bijgevolg kan $G$ opgesteld worden door $\sigma^2_{rel.~meting}$ en $\hat{\sigma}^2_{d}$ in te vullen in vergelijking \ref{eq.phi}:
	\begin{align*}
		\phi 	&=\dfrac{167.64}{167.64+  308.4843}\\
				&=\dfrac{167.64}{476.1243}=0.3521
	\end{align*}
